...
IndexDescription: Starter repository registry for GetEstablishedOnTheWebStartup web-presence Capabilities.
IndexType: README
IndexStatus: Active
...
This **starter repository** ships the web-presence Capability set for your goals,
plans, example website content, and local profile planning.
...
| Archetype | ContentReview | Review website page examples; clarity and claims | Active | [Prompt](ContentReview/Prompt.md) | [Rules](ContentReview/Rules.md) |
...
| Universal | CapabilityHarmonize | Compare Capabilities, trees, or readiness | Active | [Prompt](CapabilityHarmonize/Prompt.md) | [Rules](CapabilityHarmonize/Rules.md) |
| Universal | CapabilityAudit | Audit catalog, routing, and readiness | Active | [AuditChecklist](CapabilityAudit/AuditChecklist.md) | [Rules](CapabilityAudit/Rules.md) |
...
| Archetype | StarterRepositoryPackage | Advanced re-packaging from product source (owner scope) | Active | [WorkflowIndex](StarterRepositoryPackage/WorkflowIndex.md) | [Rules](StarterRepositoryPackage/Rules.md) |
...
**ManualIndexing** is the default. **CodeAssistedIndexing** is not shipped in
this starter.
