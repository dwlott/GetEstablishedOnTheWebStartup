...
Starter profile: GetEstablishedStartup | other active profile
Fresh mirror: yes | no
...
Use [ConsumerRepairSpec.md](ConsumerRepairSpec.md) § B and § C. Default removals:
...
Remove host-only Capability folders **before** registry rewrite. Full list:
[ConsumerRepairSpec.md](ConsumerRepairSpec.md) § E.

**Keep** consumer core (§ F). Apply GoogleDriveLink choice from Step 0.

After trim, verify folder count: **11** or **12** (if GoogleDriveLink kept).
...
Keep **exactly** the 10 Plans files in [ConsumerRepairSpec.md](ConsumerRepairSpec.md) § G.
...
Checklist: [ConsumerRepairSpec.md](ConsumerRepairSpec.md) § I.
Templates: [ConsumerBootSnippets.md](ConsumerBootSnippets.md).
