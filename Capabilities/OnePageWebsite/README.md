...
- **Inputs:** Approved or clearly provided business inputs; optional prior
  discovery from `Capabilities/GettingStarted/BusinessPlanDiscoveryPrompt.md`.
...
- Upstream discovery: [BusinessPlanDiscoveryPrompt.md](../GettingStarted/BusinessPlanDiscoveryPrompt.md)
