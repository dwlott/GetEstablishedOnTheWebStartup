...
## Cloud Inspection Profile

When the owner uses Dropbox or Google Drive for planner review, record paths in
`Workspace/OwnerPreferences.md`. Do not ship private owner paths in starter
copies — use placeholders until the owner configures connectors.
