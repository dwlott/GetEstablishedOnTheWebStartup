...
IndexDescription: Website page draft explaining GitHub as the source of truth.
IndexType: Content
IndexStatus: Draft
...
Most people arrive with a downloaded starter workspace, not a Git clone. Move
the folder out of `Downloads`, open it locally, run **Quick Startup**, then
connect **your** GitHub repository when you are ready to publish milestones.

## Where To Go Next

- Want to see how agents assist your work? **[AI Workflow](AIWorkflow.md)**.
