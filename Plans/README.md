<!--
IndexTitle: Plans Folder
IndexDescription: Setup guides and registers for the Get Established starter workspace.
IndexType: README
IndexStatus: Active
...
Setup guides and lightweight registers for this starter workspace.

| File | Purpose |
| --- | --- |
| [UserSetupGuide.md](UserSetupGuide.md) | Fuller first-session setup path |
| [SampleUserJourney.md](SampleUserJourney.md) | Example flow from ideas to drafts |
